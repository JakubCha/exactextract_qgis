...
Code in this file was copied from the "Deepness" plugin, which is available at: https://github.com/PUTvision/qgis-plugin-deepness
and modified for `Zonal Exact` plugin
Credits to the authors of the "Deepness" plugin for providing this code.
Accessed: 2024-08-09
Modified 2024-08-09 by Jakub Charyton
"""
...
REQUIREMENTS_PATH = os.path.join(
    PLUGIN_ROOT_DIR, "zonal_exact/python_requirements/qgis_requirements.txt"
)
...
class PackagesInstallerDialog(QDialog, FORM_CLASS):
    ...
    def _check_packages_installation_and_log(self) -> bool:
        ...
        if packages_ok:
            msg1 = (
                "All required packages are importable! You can close this window now!"
            )
            self.log(msg1)
            return True
